# Lab 01 — Create a Cowork Project for Finance Tasks
...
3. Add or enable `skill/finance-project-organiser/SKILL.md` in the Cowork project.
4. Open `prompts/prompt-01.txt`, paste the prompt into Cowork and review its proposed plan.
