# Lab 07 — Build a Cash-Flow Watchlist and Email Draft
...
3. Add or enable `skill/cashflow-watchlist/SKILL.md` in the Cowork project.
4. Open `prompts/prompt-07.txt`, paste the prompt into Cowork and review its proposed plan.
