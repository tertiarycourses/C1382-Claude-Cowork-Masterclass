---
name: latest-finance-dashboard
description: Find the newest dated finance file, update an Excel dashboard and refresh its charts.
---
# Pull the Latest Finance Data and Refresh Excel skill
