# Lab 08 — Schedule a Weekly Finance Briefing
...
3. Add or enable `skill/scheduled-finance-briefing/SKILL.md` in the Cowork project.
4. Open `prompts/prompt-08.txt`, paste the prompt into Cowork and review its proposed plan.
