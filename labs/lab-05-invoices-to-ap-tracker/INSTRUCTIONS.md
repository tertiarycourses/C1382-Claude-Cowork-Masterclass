# Lab 05 — Extract Invoice Details into an AP Tracker
...
3. Add or enable `skill/invoice-to-ap-tracker/SKILL.md` in the Cowork project.
4. Open `prompts/prompt-05.txt`, paste the prompt into Cowork and review its proposed plan.
